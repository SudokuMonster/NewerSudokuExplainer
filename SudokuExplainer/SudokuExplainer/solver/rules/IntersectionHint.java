...
/**
 * Locked Candidates hint (Pointing, Claiming, X-Wing, Swordfish or Jellyfish)
 */
public class IntersectionHint extends IndirectHint implements Rule, HasParentPotentialHint {
    ...
    public IntersectionHint(IndirectHintProducer rule, Cell[] cells,
    ...
    public String getName() {
        ...
        if (degree == 1) {
            ...
            if (regions[0] instanceof Grid.Block || regions[1] instanceof Grid.Block)
                return "Cascading Locked Candidates";
            else
                return "X-Wing";
        } else if (degree == 3) {
            return "Swordfish";
    ...
    public String toString() {
        ...
        if (regions != null) {
            if (regions.length == 2) {
                ...
                builder.append(" in ").append(regions.length / 2).append(" ");
                builder.append(regions[0].toString());
                builder.append("s and ").append(regions.length / 2).append(" ");
                builder.append(regions[1].toString());
                builder.append("s");
            }
        }
    ...
    private String toHtml1() {
        String result = HtmlLoader.loadHtml(this, "SimpleIntersectionHint.html");
    ...
    public String toHtml() {
        ...
        if (degree == 1)
            return toHtml1();
        final String[] numberNames = new String[] {
                "two", "three", "four", "five", "six", "seven", "eight" };
        String result = HtmlLoader.loadHtml(this, "IntersectionHint.html");
        String ruleName = getName();
        String valueName = Integer.toString(value);
    ...
    public boolean equals(Object o) {
        if (!(o instanceof IntersectionHint))
            return false;
        IntersectionHint other = (IntersectionHint)o;
