...
import SudokuExplainer.solver.rules.directed.DirectLockingHint;
 ...
 */
public class Intersection implements IndirectHintProducer {

    private final boolean isDirectMode;

    public Intersection(boolean isDirectMode) {
     ...
     */
    private <TBase extends Grid.Region, TCover extends Grid.Region> void getHints(
            Grid grid, Class<TBase> regionType1, Class<TCover> regionType2,
            HintsAccumulator accu) throws InterruptedException {
        // Locking technique must rely on block region.
    ...
    private IndirectHint createLockingHint(Grid.Region p1, Grid.Region p2, Cell hcell, int value) {
        ...
        List<Cell> highlightedCells = new ArrayList<>();
        ...
        if (isDirectMode)
            ...
            return new IntersectionHint(this, cells, value, cellPotentials,
                    cellRemovablePotentials, p1, p2);
    }
